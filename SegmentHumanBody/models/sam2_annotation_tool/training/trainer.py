...
from models.sam2_annotation_tool.training.optimizer import construct_optimizer

from models.sam2_annotation_tool.training.utils.checkpoint_utils import (
    assert_skipped_parameters_are_frozen,
    exclude_params_matching_unix_pattern,
    load_state_dict_into_model,
    with_check_parameter_frozen,
)
from models.sam2_annotation_tool.training.utils.data_utils import BatchedVideoDatapoint
from models.sam2_annotation_tool.training.utils.distributed import all_reduce_max, barrier, get_rank

from models.sam2_annotation_tool.training.utils.logger import Logger, setup_logging

from models.sam2_annotation_tool.training.utils.train_utils import (
    AverageMeter,
    collect_dict_keys,
    DurationMeter,
    get_amp_type,
...
class Trainer:
    ...
    def _load_resuming_checkpoint(self, ckpt_path: str):
        ...
        ## Load optimizer weights manually
        # self.optim.optimizer.load_state_dict(checkpoint["optimizer"])
        current_optimizer_state_dict = self.optim.optimizer.state_dict()
        for param_id, state in checkpoint["optimizer"].items():
            if param_id in current_optimizer_state_dict.items():
                current_optimizer_state_dict[param_id] = state
    ...
    def train_epoch(self, train_loader):
        ...
        for data_iter, batch in enumerate(train_loader):
            ...
            try:
                ...
                mem_meter.update(reset_peak_usage=False)
                if data_iter % self.logging_conf.log_freq == 0:
                    progress.display(data_iter)
