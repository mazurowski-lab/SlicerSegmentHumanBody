...
def build_sam_vit_t(args, checkpoint=None,  num_classes = 1, moe=-1, k=-1):
    ...
    mobile_sam = Sam(
            args, 
            image_encoder=TinyViT(args,img_size=1024, in_chans=3, num_classes=1000,
    ...
    if checkpoint is not None:
        ...
        try:
            ...
            print('Load base success with potential missing')
            #print(msg)
        except:
            print('Load base failed. Try to resize and remove last layer')
